...
public class Constants {
    ...
    public static Charset BYTE_CHARSET = Charset.forName( Constants.BYTE_ENCODING );
    public static Charset DEFAULT_CHARSET = Charset.forName(Constants.DEFAULT_ENCODING);
    ...
    public static final boolean IS_OSX = OSName.toLowerCase().startsWith(
            "mac os");
    public static final boolean IS_LINUX = OSName.equalsIgnoreCase("Linux");
