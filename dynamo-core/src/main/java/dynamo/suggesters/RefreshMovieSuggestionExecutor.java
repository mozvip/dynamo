...
public class RefreshMovieSuggestionExecutor extends TaskExecutor<RefreshMovieSuggestionTask> implements ReportProgress {
	...
	@Configurable(category="Movies", name="Movies Suggesters", required="#{MovieManager.enabled}", disabled="#{!MovieManager.enabled}", contentsClass=MovieSuggester.class, ordered=false)
